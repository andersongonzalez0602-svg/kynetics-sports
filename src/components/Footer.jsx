    ...
    <footer className="bg-navy-dark text-white">
        ...
        <div className="grid md:grid-cols-4 gap-12">
          ...
          <div>
            ...
            <div className="flex flex-col gap-2.5">
              ...
              <Link to="/responsible-gaming" className="text-blue-200/60 text-sm hover:text-white transition-colors">Responsible Gaming</Link>
            </div>
          </div>
          ...
          <div>
            ...
            <div className="flex flex-col gap-2.5">
              <Link to="/privacy" className="text-blue-200/60 text-sm hover:text-white transition-colors">Privacy Policy</Link>
              <Link to="/terms" className="text-blue-200/60 text-sm hover:text-white transition-colors">Terms of Service</Link>
              <Link to="/cookies" className="text-blue-200/60 text-sm hover:text-white transition-colors">Cookie Policy</Link>
              <Link to="/disclaimer" className="text-blue-200/60 text-sm hover:text-white transition-colors">Disclaimer</Link>
            </div>
          </div>
      ...
      <div className="border-t border-white/10">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 flex flex-col md:flex-row items-center justify-between gap-2">
          <p className="text-blue-200/40 text-sm">© 2026 Kynetics Sports. All Rights Reserved.</p>
          <p className="text-blue-200/40 text-sm text-center">For entertainment purposes only. Mascot designs and content are proprietary and protected by copyright law.</p>
