...
const GameCard = ({ game, onOpenDetail, onDelete }) => {
  ...
  return (
    ...
    >
      {isAdmin && (
        <button onClick={handleDelete} className="absolute top-2 right-2 z-20 w-7 h-7 bg-black/30 hover:bg-red/80 rounded-full flex items-center justify-center transition-colors opacity-0 group-hover:opacity-100">
